...
describe('CommunityContest', function() {
  let instance = new MathworksCommunity.CommunityContest();
      it('should create an instance of CommunityContest', function() {
        expect(instance).toBeInstanceOf(MathworksCommunity.CommunityContest);
      });
      ...
      it('should have the property replyCount (base name: "reply_count")', function() {
        // TODO: update the code to test the property replyCount
        expect(instance).toHaveProperty('replyCount');
        // expect(instance.replyCount).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property viewCount (base name: "view_count")', function() {
        // TODO: update the code to test the property viewCount
        expect(instance).toHaveProperty('viewCount');
        // expect(instance.viewCount).to.be(expectedValueLiteral);
      });

      it('should have the property voteCount (base name: "vote_count")', function() {
        // TODO: update the code to test the property voteCount
        expect(instance).toHaveProperty('voteCount');
        // expect(instance.voteCount).to.be(expectedValueLiteral);
      });
